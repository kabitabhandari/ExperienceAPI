...
public class Controller {
    ...
    @Operation(
            summary = "Get Employees with Designation",
            description = "Get Employees with Designation using GET")
    @ResponseStatus(value = HttpStatus.OK)
    @GetMapping(
            value = "/fromEmployeeWorld",
            produces = {MediaType.APPLICATION_JSON_VALUE}, // This api will produce json output
            consumes = {
                MediaType.APPLICATION_JSON_VALUE
            }) // This api will accepts/consumes json input
    public ResponseEntity<List<EmployeeDesignation>> fetchEmployeesList() {
        ...
        ResponseEntity<List<EmployeeDesignation>> customizedEmployeesList =
                employeeMapper.customizeEmployeeArray(employeeArray);
